...
- `_pages/portfolio.md` - research
- `_pages/publications.md` - publication record
- `_pages/cv.md` - web CV
- `_pages/contact.md` - contact and academic profiles

The site is built with Jekyll and derived from the Academic Pages theme.
